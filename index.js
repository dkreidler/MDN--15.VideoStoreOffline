window.onload = function() {
    ...
    // Create an instance of a db object to store database in
    let db;

    function init() {
        // Loop through video names one by one
    ...
    function fetchVideoFromNetwork(video) {
        ...
        // Fetch the MP4 and WebM version of the video using the fetch() function,
    ...
    function storeVideo(mp4Blob, webmBlob, name) {
        ...
        // craete a record to add to the IDB
        let record = {
            mp4: mp4Blob,
            webm: webmBlob,
            name: name
    ...
    // open our database; it is create if it doesn't already exist
